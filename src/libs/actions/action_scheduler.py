from libs.faults.faults import FaultSeverity, FaultException
from libs.faults.fault_logger import FaultLogger
from libs.actions.instructions import Instruction
from libs.actions.async_actions import AsyncAction
...
class ActionScheduler:
    ...
    """
    def __init__(self, logger: FaultLogger) -> None:
        self.fault_logger = logger
